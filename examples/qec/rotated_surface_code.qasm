...
h q[1]; measure q[1] -> rec[8]; h q[1]; // decomposed MX
h q[3]; measure q[3] -> rec[9]; h q[3]; // decomposed MX
h q[5]; measure q[5] -> rec[10]; h q[5]; // decomposed MX
h q[8]; measure q[8] -> rec[11]; h q[8]; // decomposed MX
h q[10]; measure q[10] -> rec[12]; h q[10]; // decomposed MX
h q[12]; measure q[12] -> rec[13]; h q[12]; // decomposed MX
h q[15]; measure q[15] -> rec[14]; h q[15]; // decomposed MX
h q[17]; measure q[17] -> rec[15]; h q[17]; // decomposed MX
