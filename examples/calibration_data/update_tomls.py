...
bloodstone_dict["doppler_cooling"]["frequency"] = data["Cooling_freq_param"][0]
...
bloodstone_dict["doppler_cooling"]["sideband_frequency"] = data[
    "Cooling_sideband_freq_param"
][0]
...
bloodstone_dict["optical_pumping"]["frequency"] = data["Pumping_freq_param"][0]
...
bloodstone_dict["detection"]["frequency"] = data["Detection_freq_param"][0]
...
bloodstone_dict["raman1"]["raw_frequency"] = 5306062750305622.0 - (
    2 * np.pi * data["Raman_carrier_freq_param"][0]
)
